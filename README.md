...
Left Click - melee attack (attacks side that cursor is on)

Right Click - Ranged weapon mode - Left click while holding right click to fire weapon towards cursor

R - reload ranged weapon

Space - use ability (currently only boost attack)

Numbers 1 - 2 - switch weapon
...
Left Bumper - left melee attack

Right Bumper - right melee attack

Left trigger - enter ranged weapon mode - right trigger while holding left trigger to fire weapon towards cursor

X - reload

A - use ability

D-Pad left/right - change melee weapon
